...
<h2 class="text-danger text-center m-2">Insert Categories</h2>
...
<input type="submit" class="bg-danger border-0 p-2 my-3 text-light" name="insert_cat" placeholder="Insert Category" value="Insert Category" >
